...
void testMap(Map mymap){
	...
	mymap.add(make_pair(1, new string("Selin Sulugoz")));
	
	mymap.add(make_pair(2, new string("Sinem Simit <3")));
	
	mymap.add(make_pair(3, new string("Egemen Ananas")));

	mymap.add(make_pair(4,new string("Misa <3")));
