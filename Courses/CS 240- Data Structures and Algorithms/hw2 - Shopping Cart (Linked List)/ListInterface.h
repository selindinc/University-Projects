...
A List is a position oriented container class that holds a linear sequence of elements.  The elements occupy positions 1 to n. This file defines the interface of the List class.  A subclass must be defined to implement the List class. 
 
NOTE: ItemType must be defined in this file. 
