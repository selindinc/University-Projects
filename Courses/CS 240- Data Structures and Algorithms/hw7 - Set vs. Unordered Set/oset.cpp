...
//output: returns inFS
//side effects: none
unordered_set<string> ReadWriteInput(unordered_set<string> s);
//input: unordered set
//output: returns unordered set
//side effects: none
int ReadDetermineSpam(unordered_set<string> s,int& numGood);
//input: unordered set and reference to number of good IPs
//output: returns number of bad IP addresses
//side effects: none
int ReadDetermineRemoveBad(unordered_set<string> s);
//input: unordered set
